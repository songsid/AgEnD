...
import { agyPoolMetrics } from "../src/usage/providers.js";
...
describe("agyPoolMetrics", () => {
  ...
  it("aggregates per-model buckets into two pools, keeping the worst fraction", () => {
    ...
    expect(metrics).toEqual([
      { label: "Gemini", type: "percent", used: expect.closeTo(60, 5), resetsAt: "2026-08-08T16:12:24Z" },
      { label: "Claude & others", type: "percent", used: expect.closeTo(50, 5), resetsAt: "2026-08-08T16:12:24Z" },
    ]);
  });
