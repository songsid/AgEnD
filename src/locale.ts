...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "inst.respawn_paused": "🔴 {0} keeps crashing shortly after launch — respawn paused. Check rate limits or run `agend fleet restart`.",
  ...
  "zh-TW": {
    ...
    "cost.limit_reached": "🛑 {0} 已達每日上限 {1} — 暫停實例。",
    "general.start_failed": "⚠️ General 實例「{0}」啟動失敗：\n{1}",
    ...
    "restart.full_initiated": "🔄 開始完整重啟 — 等待所有實例閒置後重載程序...",
    "restart.graceful_initiated": "🔄 開始優雅重啟 — 等待所有實例閒置...",
    ...
    "inst.respawn_paused": "🔴 {0} 啟動後一直崩潰 — 暫停重生。檢查 rate limit 或執行 `agend fleet restart`。",
