...
const enMessages = {
    ...
    "ctx.auto_pause": "Auto-pause: {0}",
    "ctx.auto_pause_disabled": "Auto-pause: disabled",
    "ctx.paused": "⏸ Paused",
    ...
    "inst.codex_usage_limit_luna_reserve": "⚡ {0}: Codex usage limit reached — automatically selected Continue with Luna Reserve. You can override with /model.",
    "inst.codex_capacity_backoff_retry": "⏳ {0}: model at capacity (attempt {1}/{2}) — retrying in {3}s.",
    "inst.codex_capacity_backoff_exhausted": "⚠️ {0}: model still at capacity after {1} retries — pausing. Use /model to switch to another model.",
...
const zhTWMessages: { [K in keyof typeof enMessages]: string } = {
    ...
    "ctx.auto_pause": "Auto-pause：{0}",
    "ctx.auto_pause_disabled": "Auto-pause：已停用",
    "ctx.paused": "⏸ 已暫停",
    ...
    "inst.codex_usage_limit_luna_reserve": "⚡ {0}：Codex 使用額度達上限——已自動選擇「Continue with Luna Reserve」。可用 /model 切換覆蓋。",
    "inst.codex_capacity_backoff_retry": "⏳ {0}：模型服務擁擠（第 {1}/{2} 次）— {3}s 後重試。",
    "inst.codex_capacity_backoff_exhausted": "⚠️ {0}：模型服務擁擠（已重試 {1} 次）— 暫停中。請用 /model 切換其他模型。",
