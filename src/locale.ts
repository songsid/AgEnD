...
const enMessages = {
    ...
    "fleet.topic_probe_unknown": "⚠️ Could not verify {0}'s topic through adapter {1}. The instance, configuration, and working directory were retained.",
...
const zhTWMessages: { [K in keyof typeof enMessages]: string } = {
    ...
    "fleet.topic_probe_unknown": "⚠️ 無法透過 adapter {1} 確認 {0} 的 topic 狀態。instance、設定與工作目錄均已保留。",
